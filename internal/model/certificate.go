...
type Certificate struct {
	...
	UserID            uuid.UUID `gorm:"type:uuid;not null;index;uniqueIndex:idx_certificate_user_course,priority:1" json:"user_id"`
	CourseID          uuid.UUID `gorm:"type:uuid;not null;index;uniqueIndex:idx_certificate_user_course,priority:2" json:"course_id"`
