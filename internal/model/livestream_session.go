...
type LivestreamSession struct {
	...
	Platform        string                  `gorm:"type:varchar(20);default:'40study'" json:"platform"`
	CustomLink      *string                 `gorm:"type:varchar(500)" json:"custom_link,omitempty"`
	EnableReminder  bool                    `gorm:"default:true" json:"enable_reminder"`
