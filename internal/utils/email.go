...
func SendRegisterOTP(cfg *config.Config, to string, otp string) error {
	subject := "Xác thực tài khoản forteX"
          ...
          <tr>
            <td style="padding:20px;">
              ...
              <h2 style="margin:0 0 20px; font-size:20px; font-weight:bold;">
                Xác thực tài khoản forteX
              </h2>
              
              <p style="margin:0 0 20px;">
                Chào mừng bạn đến với forteX! Để hoàn tất đăng ký tài khoản, vui lòng nhập mã xác thực bên dưới vào ứng dụng.
              </p>
              ...
              <div style="margin-top:20px; padding:15px; background:#f8f9fa; border-radius:3px;">
                ...
                <ul style="margin:0; padding:0 0 0 20px; list-style-type:disc; color:#5f6368; font-size:13px;">
                  <li style="margin-bottom:5px;">Không chia sẻ mã này với bất kỳ ai, kể cả nhân viên forteX</li>
                  <li style="margin-bottom:5px;">forteX không bao giờ yêu cầu mã xác thực qua điện thoại hoặc tin nhắn</li>
...
func SendResetPasswordOTP(cfg *config.Config, to string, otp string) error {
	subject := "Đặt lại mật khẩu forteX của bạn"
        ...
        <table width="600" cellpadding="0" cellspacing="0" border="0" style="background:#ffffff; border-radius:3px; overflow:hidden;">
          ...
          <tr>
            <td style="padding:20px;">
              ...
              <h2 style="margin:0 0 20px; font-size:20px; font-weight:bold;">
                Đặt lại mật khẩu forteX
              </h2>
              
              <p style="margin:0 0 20px;">
                Chúng tôi đã nhận được yêu cầu đặt lại mật khẩu cho tài khoản forteX của bạn. Sử dụng mã xác thực bên dưới để tiếp tục.
              </p>
...
func ChangePasswordNotify(cfg *config.Config, to string) error {
	subject := "Mật khẩu forteX của bạn đã được thay đổi"
        ...
        <table width="600" cellpadding="0" cellspacing="0" border="0" style="background:#ffffff; border-radius:3px; overflow:hidden;">
          ...
          <tr>
            <td style="padding:20px;">
              ...
              <h2 style="margin:0 0 20px; font-size:20px; font-weight:bold;">
                Mật khẩu forteX đã được thay đổi
              </h2>
              
              <p style="margin:0 0 20px;">
                Đây là xác nhận rằng mật khẩu cho tài khoản forteX của bạn đã được thay đổi thành công. Tài khoản của bạn giờ đây được bảo mật với mật khẩu mới.
              </p>
              ...
              <div style="margin-top:20px; padding:15px; background:#f8f9fa; border-radius:3px;">
                ...
                <ul style="margin:0; padding:0 0 0 20px; list-style-type:disc; color:#5f6368; font-size:13px;">
                  <li style="margin-bottom:5px;">Sử dụng mật khẩu duy nhất cho forteX</li>
